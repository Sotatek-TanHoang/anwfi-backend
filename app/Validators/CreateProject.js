...
class CreateProject {
  get rules() {
    return {
      ...
      // whitelist_hardcap: 'required|number',
      // other_hardcap: 'required|number',
      // whitelist_trigger: 'required|number',
      // other_trigger: 'required|number',
      // whitelist_untrigger: 'required|number',
      // other_untrigger: 'required|number',
      start_time: 'required',
